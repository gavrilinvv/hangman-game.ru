export const WORDS = [
	...
	{name: 'канада', theme: 'Страна'},
	{name: 'россия', theme: 'Страна'},
	{name: 'сербия', theme: 'Страна'},
	{name: 'латвия', theme: 'Страна'},
	{name: 'грузия', theme: 'Страна'},
	{name: 'израиль', theme: 'Страна'},
	{name: 'албания', theme: 'Страна'},
	{name: 'бельгия', theme: 'Страна'},
	{name: 'марокко', theme: 'Страна'},
	...
	{name: 'сингапур', theme: 'Страна'},
	{name: 'колумбия', theme: 'Страна'},
	{name: 'казахстан', theme: 'Страна'},
	{name: 'венесуэла', theme: 'Страна'},
	{name: 'никарагуа', theme: 'Страна'},
	...
	{name: 'люксембург', theme: 'Страна'},
	{name: 'афганистан', theme: 'Страна'},
	{name: 'черногория', theme: 'Страна'},
	{name: 'португалия', theme: 'Страна'},
	{name: 'нидерланды', theme: 'Страна'},
	{name: 'азербайджан', theme: 'Страна'},
	{name: 'новая зеландия', theme: 'Страна'},
	{name: 'саудовская аравия', theme: 'Страна'},
	...
	{name: 'олово', theme: 'Химические элементы'},
	{name: 'гелий', theme: 'Химические элементы'},
	{name: 'селен', theme: 'Химические элементы'},
	{name: 'магний', theme: 'Химические элементы'},
	{name: 'золото', theme: 'Химические элементы'},
	{name: 'фосфор', theme: 'Химические элементы'},
	{name: 'углерод', theme: 'Химические элементы'},
